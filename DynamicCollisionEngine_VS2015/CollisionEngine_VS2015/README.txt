#Collision Engine Exercise
## Goal
By implementing a collision detection and response system, this engine must be able to correctly replicate coherent physic behavior, and be stable whatever the FPS amount.
This also aims at undertsanding the internal features of a physics engine.
